...
import { HttpMetricsOptions } from './http-metrics-options';

const { ConfigurableModuleClass, OPTIONS_TYPE, ASYNC_OPTIONS_TYPE, MODULE_OPTIONS_TOKEN } =
  new ConfigurableModuleBuilder<HttpMetricsOptions>()
...
export {
  ...
  AsyncOptions as HttpMetricsAsyncOptionsType,
  MODULE_OPTIONS_TOKEN as HttpMetricsModuleToken,
  Options as HttpMetricsOptionsType,
};
